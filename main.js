...
function main() {
    ...
    function preload() {
        var assets = {
            spritesheet: {
                birdie: ['assets/ptero.png', 330, 205],
    ...
    function create() {
        ...
        invs = game.add.group();
        // Add birdie
        birdie = game.add.sprite(150, 150, 'birdie');
    ...
    function setGameOver() {
        gameOver = true;
        instText.setText("TOUCH PTERO OR\nHIT SPACE\nTO TRY AGAIN");
